...
let initiallog:Log = LogBuilder::new().settimestamp("bora.arseven@gmail.com".parse().unwrap()).setpw("122134".parse().unwrap()).build();
println!("{:?}", initiallog);
}
...
impl Log {
    ...
    fn new(timestamp: String, request_type: Request, endpoint_url: String, status_code: i16, responsetime:i32) -> LogBuilder{
